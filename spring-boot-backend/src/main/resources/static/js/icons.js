...
(function () {
  ...
  var ICONS = {
    ...
    // Payment methods (POS payment-method chips). Without these four the shim
    // fell through to FALLBACK and every chip rendered the same "..." glyph.
    'cash-coin': svg('<rect x="2" y="7" width="15" height="10" rx="2"/><circle cx="9.5" cy="12" r="2"/><path d="M20 9v8a2 2 0 0 1-2 2H5"/>'),
    'credit-card-2-front': svg('<rect x="2" y="5" width="20" height="14" rx="2"/><path d="M2 10h20"/><path d="M6 15h4"/>'),
    'bank': svg('<path d="M3 21h18"/><path d="M12 3 3 8h18l-9-5Z"/><path d="M5 11v7M9.5 11v7M14.5 11v7M19 11v7"/>'),
    'wallet2': svg('<path d="M21 12V8a2 2 0 0 0-2-2H5a2 2 0 0 1 0-4h13"/><path d="M3 4v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-2"/><path d="M18 12a2 2 0 0 0 0 4h4v-4Z"/>'),
    ...
    'shop': svg('<path d="M3 9h18l-1.5-5H4.5L3 9Z"/><path d="M4 9v11h16V9"/><path d="M9 20v-6h6v6"/>'),
